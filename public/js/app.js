...
function initAdmin() {
  ...
  function renderItems(items) {
    //Displays items and their ordered quantities for each order
...
var addToCart = document.querySelectorAll('.add-to-cart'); //Get all the add to cart buttons. addToCart is an array.

var cartCounter = document.querySelector('#cartCounter'); //# is for selecting id

function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', pizza).then(function (res) {
    //We make an ajax call using axios library here as it is used to send requests to server
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    updateCart(pizza); //dataset is used for getting data attribute
...
__webpack_require__(/*! F:\Fawaaz\Web development\Realtime Pizza Order Tracker Application\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! F:\Fawaaz\Web development\Realtime Pizza Order Tracker Application\resources\scss\app.scss */"./resources/scss/app.scss");
